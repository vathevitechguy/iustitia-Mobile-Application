...
public class LoginActivity extends AppCompatActivity {
	...
	private ScrollView vscroll_login;
	private ScrollView vscroll_signup;
	private ScrollView vscroll_forgotpass;
	...
	private void initialize(Bundle _savedInstanceState) {
		...
		vscroll_login = (ScrollView) findViewById(R.id.vscroll_login);
		vscroll_signup = (ScrollView) findViewById(R.id.vscroll_signup);
		vscroll_forgotpass = (ScrollView) findViewById(R.id.vscroll_forgotpass);
		...
		textview4.setOnClickListener(new View.OnClickListener() {
			...
			public void onClick(View _view) {
				...
				linear_forgotpasspg.setVisibility(View.VISIBLE);
			}
		});
		...
		textview14.setOnClickListener(new View.OnClickListener() {
			...
			public void onClick(View _view) {
				...
				startActivity(home);
				SketchwareUtil.showMessage(getApplicationContext(), "Login Skipped");
				finish();
			}
		});
			...
			public void onClick(View _view) {
				if (edittext3.getText().toString().equals("") || (edittext4.getText().toString().equals("") || (edittext5.getText().toString().equals("") || edittext6.getText().toString().equals("")))) {
					...
					if (edittext5.getText().toString().equals(edittext6.getText().toString())) {
						auth.createUserWithEmailAndPassword(edittext4.getText().toString(), edittext6.getText().toString()).addOnCompleteListener(LoginActivity.this, _auth_create_user_listener);
		...
		button4.setOnClickListener(new View.OnClickListener() {
			...
			public void onClick(View _view) {
				if (edittext7.getText().toString().equals("")) {
					...
					auth.sendPasswordResetEmail(edittext7.getText().toString()).addOnCompleteListener(_auth_reset_password_listener);
